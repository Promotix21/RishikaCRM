...
import { Success, clearAlert } from './Alert';
import { addAdminCallback } from '../services/LeadAPI';
    ...
    const handleSubmit =async (e)=>{
        ...
        const actualData = {
          ...
          if (actualData.call_back_date && actualData.call_back_comment) {
            ...
            const res = await addAdminCallback(id,actualData)
    ...
    <Card className="p-2 m-1 card">
      ...
      <Header title="Lead Details"/>
        ...
        <Row>
            ...
            <Col sm={6}><p className='text'><CalendarMonthIcon fontSize='large' sx={{marginRight:'20px',color:'#36454F'}}/> {dayjs(user.date_of_visit).toString()}</p></Col>
        </Row>
        <Row>
